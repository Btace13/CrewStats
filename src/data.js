...
const data = {
  menus: [
    ...
    { text: 'Btace13', icon: <PermIdentity/>, link: '/btace' },
    { text: 'Btared', icon: <PermIdentity/>, link: '/btared' },
    { text: 'Bigbully3', icon: <PermIdentity/>, link: '/bigbully' },
    { text: 'Arcell', icon: <PermIdentity/>, link: '/arcell' },
    { text: 'LuisFYA', icon: <PermIdentity/>, link: '/luis' }
  ],
  tablePage: {
    items: [
